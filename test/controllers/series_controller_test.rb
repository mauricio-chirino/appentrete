...
class SeriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create series" do
    assert_difference("Series.count") do
      post series_index_url, params: { series: { director: @series.director, imagen: @series.imagen, name: @series.name, sinopsis: @series.sinopsis } }
    end
  ...
  test "should update series" do
    patch series_url(@series), params: { series: { director: @series.director, imagen: @series.imagen, name: @series.name, sinopsis: @series.sinopsis } }
